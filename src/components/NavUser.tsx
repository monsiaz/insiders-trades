  ...
  return (
    <div ref={ref} className="relative">
      <button onClick={() => setOpen((o) => !o)}
        style={{ display: "flex", alignItems: "center", gap: "8px", padding: "8px 10px", minHeight: "44px", borderRadius: "10px", background: "transparent", border: "none", cursor: "pointer" }}
      ...
      {open && (
        <div className="card" style={{ position: "absolute", right: 0, top: "calc(100% + 8px)", width: "min(220px, calc(100vw - 16px))", zIndex: 200, padding: "6px 0", boxShadow: "var(--shadow-lg)" }}>
